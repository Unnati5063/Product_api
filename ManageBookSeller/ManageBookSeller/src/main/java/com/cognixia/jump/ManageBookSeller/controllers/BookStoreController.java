...
import com.cognixia.jump.ManageBookSeller.security.services.BookStoreService;
...
public class BookStoreController {
    ...
    public List<BookDto> getBookByCategoryKeyWord(@RequestParam String keyword) {
        return bookStoreService.getBookByCategoryKeyWord(keyword);
    }
    ...
    public int getNumberOfBooksSoldByCategoryAndKeyword(@RequestParam String keyword) {
        return bookStoreService.getNumberOfBooksSoldByCategoryAndKeyword(keyword);
    }
